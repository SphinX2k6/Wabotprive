 ...
 if (cooldownManager.checkCooldown(inputCMD, module.exports.cooldown) > 0) {
    ...
    switch (inputCMD) {
      ...
      case "toimage":
        ...
        let mediaMess = await Infinity.downloadAndSaveMediaMessage(quoted);
      ...
      case "tomp4":
        ...
        let mediaMess2 = await Infinity.downloadAndSaveMediaMessage(quoted);
      ...
      case "togif":
        ...
        let mediaMess3 = await Infinity.downloadAndSaveMediaMessage(quoted);
      ...
      case "tomp3":
        ...
        await Infinity.sendPresenceUpdate("recording", m.from);
      ...
      case "tourl":
        ...
        let media5 = await Infinity.downloadAndSaveMediaMessage(quoted);
        if (/image/.test(mime)) {
          await doReact("🔗");
      ...
      case "imgtopdf":
        if (/image/.test(mime)) {
          await doReact("📑");
          let mediaMess4 = await Infinity.downloadAndSaveMediaMessage(quoted);
