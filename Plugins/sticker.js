    ...
    switch (inputCMD) {
      ...
      case "sticker":
        if (/image/.test(mime)) {
          ...
          Infinity.sendMessage(m.from, { sticker: stickerBuffer }, { quoted: m });
          ...
          Infinity.sendMessage(m.from, { sticker: stickerBuffer2 }, { quoted: m });
        } else {
          await doReact("❌");
          m.reply(
      ...
      case "stickermeme":
        ...
        if (/image/.test(mime)) {
          ...
          await doReact("📮");
          media = await Infinity.downloadAndSaveMediaMessage(quoted);
          await sleep(2000)
        ...
        } catch(e) { m.reply(`Got error! try with out any special character or emoji`+e)}
        break;
